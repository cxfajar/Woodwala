<x-admin_header title="Manage Whole Seller"/>
        ...
        <div class="min-height-200px">
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Wholesallers {{ $count_active }}
                                </li>
                            </ol>
                        </nav>
                    </div>
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <table class="table table-hover">
                                            ...
                                            @endphp
                                            <tbody>
                                                @foreach ($requested_wholesaller as $cust)
                                                <tr>
                                                    <td>{{ $total }}</td>
                ...
                <div class="modal fade" id="myModal">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            ...
                            <!-- Modal Header -->
                            <div class="modal-header">
                                <h4 class="modal-title">Blocked Wholesaller</h4>
                            ...
                            <div class="modal-body">
                                <table class="table table-hover">
                                    ...
                                    @endphp
                                    <tbody>
                                        @foreach ($blocked_wholesaller as $cust)
                                        <tr>
                                            <td>{{ $total }}</td>
                                            <td>{{ $cust->first_name." ".$cust->last_name }}</td>
                                            <td>{{ $cust->email }}</td>
                ...
                <table class="table table-hover">
                    ...
                    @endphp
                    <tbody>
                        @foreach ($active_wholesaller as $cust)
                        <tr>
                            <td>{{ $total }}</td>
                            <td>{{ $cust->first_name." ".$cust->last_name }}</td>
                            <td>{{ $cust->email }}</td>
